...
def load_opts():
    ...
    # -- training
    parser.add_argument('--train_list', type=str, required=True, help='Path to training video list')
    parser.add_argument('--number_sample', type=int, default=4, help='Number of samples per video')
